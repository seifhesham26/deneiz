    ...
    <footer className="mt-auto border-t border-border bg-surface">
      <div className="content-shell">
        ...
        >
          ...
          <nav aria-label={t.footer.shopLinks} className="flex flex-col gap-3 text-sm">
            <span className="eyebrow">{t.footer.shopLinks}</span>
            <Link href="/products" className="text-text-secondary transition-colors hover:text-text-primary">
              {t.nav.products}
            </Link>
            <Link href="/wishlist" className="text-text-secondary transition-colors hover:text-text-primary">
              {t.nav.wishlist}
            </Link>
          ...
          <nav aria-label={t.footer.supportLinks} className="flex flex-col gap-3 text-sm">
            <span className="eyebrow">{t.footer.supportLinks}</span>
          ...
          <div className="flex flex-col gap-3 text-sm">
            <span className="eyebrow">{t.footer.contactUs}</span>
            <span className="flex items-center gap-2 text-text-secondary" dir="ltr">
              <Mail aria-hidden className="size-4 shrink-0" /> support@deneiz.com
            </span>
            <span className="flex items-center gap-2 text-text-secondary" dir="ltr">
              <Phone aria-hidden className="size-4 shrink-0" /> +966 55 000 0000
            </span>
