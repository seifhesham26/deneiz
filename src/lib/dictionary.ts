...
const en = {
  ...
  confirmation: {
    ...
    keepNumber: "Keep this number — you can track your order with it any time.",
    trackOrder: "Track this order",
  },
  orderLookup: {
    title: "Track your order",
    subtitle: "Enter the order number and the phone number used at checkout.",
    orderNumberLabel: "Order number",
    orderNumberPlaceholder: "DNZ-20260825-A1B2",
  ...
  errors: {
    ...
    changeNonZero: "Enter an adjustment other than zero",
    duplicateReview: "You have already reviewed this product",
    orderLookupFailed: "No order matches that number and phone number",
...
const ar: DeepDictionary = {
  ...
  confirmation: {
    ...
    keepNumber: "احتفظ بهذا الرقم — يمكنك تتبّع طلبك به في أي وقت.",
    trackOrder: "تتبّع هذا الطلب",
  },
  orderLookup: {
    title: "تتبّع طلبك",
    subtitle: "أدخل رقم الطلب ورقم الهاتف المستخدم عند الشراء.",
  ...
  errors: {
    ...
    changeNonZero: "أدخل قيمة تعديل غير الصفر",
    duplicateReview: "لقد قمت بمراجعة هذا المنتج بالفعل",
    orderLookupFailed: "لا يوجد طلب مطابق لهذا الرقم ورقم الهاتف",
